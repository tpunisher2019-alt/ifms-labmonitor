...
function updateActionButtons() { $("inventory-refresh").disabled = !state.selected.size; $("send-update").disabled = !state.remoteUpdatesEnabled || !compatibleSelectedIds().length || !$("release-select").value; }
