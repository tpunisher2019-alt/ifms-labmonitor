...
try {
    ...
    foreach ($name in @('agent.py','service.py','requirements.txt','config.json','README.md','install-windows.bat','install-windows.ps1','install-linux.sh','labmonitor-python-preview.service')) {
